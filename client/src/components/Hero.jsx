...
const Hero = () => {
    ...
    return (
        <div className='flex flex-col items-start justify-center px-4 sm:px-6 md:px-16 lg:px-24 xl:px-32 text-white bg-[url("/src/assets/heroImage.png")] bg-no-repeat bg-cover bg-center min-h-screen'>
            ...
            <h1 className='font-playfair text-2xl sm:text-3xl md:text-[56px] md:leading-[56px] font-bold md:font-extrabold max-w-xl mt-4'>Discover Your Perfect Gateway Destination</h1>
            ...
            <form onSubmit={onSearch} className='bg-white text-gray-500 rounded-lg px-4 sm:px-6 py-4 mt-8 flex flex-col md:flex-row max-md:items-stretch gap-4 max-md:mx-auto w-full max-w-4xl'>
                ...
                <div className='flex md:flex-col max-md:gap-2 max-md:items-start'>
                    ...
                    <input min={1} max={4} id="guests" type="number" className="rounded border border-gray-200 px-3 py-1.5 mt-1.5 text-sm outline-none w-full md:max-w-16" placeholder="0" />
                </div>
