...
const Footer = () => {
    return (
        <div className='bg-[#F6F9FC] text-gray-500/80 pt-8 px-4 sm:px-6 md:px-16 lg:px-24 xl:px-32'>
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-6'>
                ...
                <div className='w-full max-w-80'>
                    ...
                    <div className='flex items-center mt-4 w-full'>
                        <input type="text" className='bg-white rounded-l border border-gray-300 h-9 px-3 outline-none w-full min-w-0' placeholder='Your email' />
                        <button className='flex items-center justify-center bg-black h-9 w-10 shrink-0 rounded-r'>
            ...
            <div className='flex flex-col md:flex-row gap-3 md:gap-2 items-center justify-between py-5 text-center md:text-left'>
